    ...
    options: [
        {
            ...
            series: [
                {data: storage.dataMap.dataGDP['2002']},
                {data: storage.dataMap.dataFinancial['2002']},
                {data: storage.dataMap.dataEstate['2002']},
                {data: storage.dataMap.dataPI['2002']},
                {data: storage.dataMap.dataSI['2002']},
                {data: storage.dataMap.dataTI['2002']},
                {data: [
                    {name: '第一产业', value: storage.dataMap.dataPI['2002sum']},
                    {name: '第二产业', value: storage.dataMap.dataSI['2002sum']},
                    {name: '第三产业', value: storage.dataMap.dataTI['2002sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                {data: storage.dataMap.dataGDP['2003']},
                {data: storage.dataMap.dataFinancial['2003']},
                {data: storage.dataMap.dataEstate['2003']},
                {data: storage.dataMap.dataPI['2003']},
                {data: storage.dataMap.dataSI['2003']},
                {data: storage.dataMap.dataTI['2003']},
                {data: [
                    {name: '第一产业', value: storage.dataMap.dataPI['2003sum']},
                    {name: '第二产业', value: storage.dataMap.dataSI['2003sum']},
                    {name: '第三产业', value: storage.dataMap.dataTI['2003sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                {data: storage.dataMap.dataGDP['2004']},
                {data: storage.dataMap.dataFinancial['2004']},
                {data: storage.dataMap.dataEstate['2004']},
                {data: storage.dataMap.dataPI['2004']},
                {data: storage.dataMap.dataSI['2004']},
                {data: storage.dataMap.dataTI['2004']},
                {data: [
                    {name: '第一产业', value: storage.dataMap.dataPI['2004sum']},
                    {name: '第二产业', value: storage.dataMap.dataSI['2004sum']},
                    {name: '第三产业', value: storage.dataMap.dataTI['2004sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                {data: storage.dataMap.dataGDP['2005']},
                {data: storage.dataMap.dataFinancial['2005']},
                {data: storage.dataMap.dataEstate['2005']},
                {data: storage.dataMap.dataPI['2005']},
                {data: storage.dataMap.dataSI['2005']},
                {data: storage.dataMap.dataTI['2005']},
                {data: [
                    {name: '第一产业', value: storage.dataMap.dataPI['2005sum']},
                    {name: '第二产业', value: storage.dataMap.dataSI['2005sum']},
                    {name: '第三产业', value: storage.dataMap.dataTI['2005sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                {data: storage.dataMap.dataGDP['2006']},
                {data: storage.dataMap.dataFinancial['2006']},
                {data: storage.dataMap.dataEstate['2006']},
                {data: storage.dataMap.dataPI['2006']},
                {data: storage.dataMap.dataSI['2006']},
                {data: storage.dataMap.dataTI['2006']},
                {data: [
                    {name: '第一产业', value: storage.dataMap.dataPI['2006sum']},
                    {name: '第二产业', value: storage.dataMap.dataSI['2006sum']},
                    {name: '第三产业', value: storage.dataMap.dataTI['2006sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                {data: storage.dataMap.dataGDP['2007']},
                {data: storage.dataMap.dataFinancial['2007']},
                {data: storage.dataMap.dataEstate['2007']},
                {data: storage.dataMap.dataPI['2007']},
                {data: storage.dataMap.dataSI['2007']},
                {data: storage.dataMap.dataTI['2007']},
                {data: [
                    {name: '第一产业', value: storage.dataMap.dataPI['2007sum']},
                    {name: '第二产业', value: storage.dataMap.dataSI['2007sum']},
                    {name: '第三产业', value: storage.dataMap.dataTI['2007sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                {data: storage.dataMap.dataGDP['2008']},
                {data: storage.dataMap.dataFinancial['2008']},
                {data: storage.dataMap.dataEstate['2008']},
                {data: storage.dataMap.dataPI['2008']},
                {data: storage.dataMap.dataSI['2008']},
                {data: storage.dataMap.dataTI['2008']},
                {data: [
                    {name: '第一产业', value: storage.dataMap.dataPI['2008sum']},
                    {name: '第二产业', value: storage.dataMap.dataSI['2008sum']},
                    {name: '第三产业', value: storage.dataMap.dataTI['2008sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                {data: storage.dataMap.dataGDP['2009']},
                {data: storage.dataMap.dataFinancial['2009']},
                {data: storage.dataMap.dataEstate['2009']},
                {data: storage.dataMap.dataPI['2009']},
                {data: storage.dataMap.dataSI['2009']},
                {data: storage.dataMap.dataTI['2009']},
                {data: [
                    {name: '第一产业', value: storage.dataMap.dataPI['2009sum']},
                    {name: '第二产业', value: storage.dataMap.dataSI['2009sum']},
                    {name: '第三产业', value: storage.dataMap.dataTI['2009sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                {data: storage.dataMap.dataGDP['2010']},
                {data: storage.dataMap.dataFinancial['2010']},
                {data: storage.dataMap.dataEstate['2010']},
                {data: storage.dataMap.dataPI['2010']},
                {data: storage.dataMap.dataSI['2010']},
                {data: storage.dataMap.dataTI['2010']},
                {data: [
                    {name: '第一产业', value: storage.dataMap.dataPI['2010sum']},
                    {name: '第二产业', value: storage.dataMap.dataSI['2010sum']},
                    {name: '第三产业', value: storage.dataMap.dataTI['2010sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                {data: storage.dataMap.dataGDP['2011']},
                {data: storage.dataMap.dataFinancial['2011']},
                {data: storage.dataMap.dataEstate['2011']},
                {data: storage.dataMap.dataPI['2011']},
                {data: storage.dataMap.dataSI['2011']},
                {data: storage.dataMap.dataTI['2011']},
                {data: [
                    {name: '第一产业', value: storage.dataMap.dataPI['2011sum']},
                    {name: '第二产业', value: storage.dataMap.dataSI['2011sum']},
                    {name: '第三产业', value: storage.dataMap.dataTI['2011sum']}
                ]}
            ]
        }
    ]
