...
const storage = { latlong, mapData };

const getOption = (storage) => {
var max = -Infinity;
var min = Infinity;
storage.mapData.forEach(function (itemOpt) {
    ...
    series : [
        {
            ...
            data: storage.mapData.map(function (itemOpt) {
                return {
                    name: itemOpt.name,
                    value: [
                        storage.latlong[itemOpt.code].longitude,
                        storage.latlong[itemOpt.code].latitude,
                        itemOpt.value
                    ],
                    label: {
                        emphasis: {
